...
import heroImg from '../../assets/usa-flight.jpg';

// --- ASSET IMPORTS ---
import usa from '../../assets/usaimg/usa.jpg'; 
import usa1 from '../../assets/usaimg/usa2.jpg';
import usa2 from '../../assets/usaimg/usa3.jpg';
import usa3 from '../../assets/usaimg/usa4.jpg';
...
const USAPage = () => {
  ...
  const galleryImages = [usa, usa1, usa2, usa3];
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 w-full relative z-10">
          <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            <div className="flex items-center gap-4 mb-4">
              ...
              <span className="text-white text-xs md:text-sm font-black uppercase tracking-[0.4em]">FAA Pilot Training</span>
            </div>
            <h1 className="text-white text-5xl md:text-8xl font-black uppercase italic leading-[0.9] tracking-tighter">
              UNITED STATES <br /> <span className="text-transparent" style={{ WebkitTextStroke: '1px white' }}>OF AMERICA</span>
            </h1>
          </motion.div>
        </div>
      </section>
          ...
          <div className="lg:col-span-8">
            <header className="mb-12">
                <h2 className="text-3xl md:text-5xl font-black uppercase italic text-[#1a2e6e] leading-tight">
                    AirLink Flight School <br/>
                    <span className="text-[#e21d1d]">Florida Hub</span>
                </h2>
            </header>
            ...
            <div className="space-y-6 text-lg md:text-xl text-gray-600 leading-relaxed">
              <p className="font-bold text-[#1a2e6e] border-l-4 border-[#e21d1d] pl-6 italic">
                Through our exclusive partnership with AirLink Flight School in Florida, Aerius Aviators offers Indian students a streamlined pathway to earning a Commercial Pilot Licence (CPL).
              </p>
              <p>
                AirLink, an FAA-accredited institution, provides structured training programs and a modern fleet enhanced by Florida’s excellent year-round flying conditions.
              </p>
            </div>

            {/* --- MODERN GRID (No Captions) --- */}
            <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              {galleryImages.map((img, index) => (
                <motion.div
                  ...
                  className="group relative h-64 md:h-80 rounded-[2rem] overflow-hidden cursor-zoom-in bg-gray-100 shadow-lg"
                >
                  <img 
                    src={img} 
                    alt="USA Flight Training"
          ...
          <div className="lg:col-span-4">
            <div className="bg-[#1a2e6e] p-10 rounded-[3rem] text-white sticky top-24 shadow-2xl overflow-hidden border border-white/5">
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-black uppercase mb-6 tracking-tight italic">FAA Pathway</h3>
                
                <ul className="space-y-5 text-sm font-bold uppercase tracking-widest text-white/60">
                  <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-[#e21d1d]" /> Florida Hub</li>
                  <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-[#e21d1d]" /> Modern Fleet</li>
                  <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-[#e21d1d]" /> FAA Accredited</li>
                  <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-[#e21d1d]" /> 24/7 Guidance</li>
                </ul>
