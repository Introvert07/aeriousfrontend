...
import heroImg from '../../assets/spain-flight.png';

// --- ASSET IMPORTS ---
import spain from '../../assets/spainimg/spain.jpg';
import spain2 from '../../assets/spainimg/spain2.jpg';
...
const SpainPage = () => {
  ...
  const galleryImages = [spain, spain2];
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 w-full relative z-10">
          <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            <div className="flex items-center gap-4 mb-4">
              ...
              <span className="text-white text-xs md:text-sm font-black uppercase tracking-[0.4em]">EASA Pilot Training</span>
            </div>
            <h1 className="text-white text-5xl md:text-8xl font-black uppercase italic leading-[0.9] tracking-tighter">
              SPAIN <br /> <span className="text-transparent" style={{ WebkitTextStroke: '1px white' }}>EUROPEAN PATH</span>
            </h1>
          ...
          <div className="lg:col-span-8">
            ...
            <div className="space-y-6 text-lg md:text-xl text-gray-600 leading-relaxed">
              <p className="font-bold text-[#1a2e6e] border-l-4 border-[#e21d1d] pl-6 italic">
                Experience the thrill of flying over Spain’s diverse landscapes—from golden coastlines and vineyards to historic cities and mountain ranges.
              </p>
              <p>
                With over 300 sunny days a year, Spain offers near-perfect flying weather. Students train under EASA standards, making their licences widely recognized across Europe. Immerse yourself in rich culture while receiving top-tier aviation instruction.
              </p>
            </div>
          ...
          <div className="lg:col-span-4">
            <div className="bg-[#1a2e6e] p-10 rounded-[3rem] text-white sticky top-24 shadow-2xl overflow-hidden border border-white/5">
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-black uppercase mb-6 tracking-tight italic">EASA Pathway</h3>
                
                <ul className="space-y-5 text-sm font-bold uppercase tracking-widest text-white/60">
                  <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-[#e21d1d]" /> 300+ Sunny Days</li>
                  <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-[#e21d1d]" /> EASA Approved</li>
                  <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-[#e21d1d]" /> Global Recognition</li>
                  <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-[#e21d1d]" /> Cultural Immersion</li>
                </ul>
