...
import heroImg from '../../assets/sa-flight.png';

// --- ASSET IMPORTS ---
import sa from '../../assets/saimg/sa.jpg'; 
import sa2 from '../../assets/saimg/sa2.jpg';
import sa3 from '../../assets/saimg/sa3.jpg';
import sa4 from '../../assets/saimg/sa4.jpg';
...
const SouthAfricaPage = () => {
  ...
  const galleryImages = [sa, sa2, sa4, sa3];
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 w-full relative z-10">
          <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            <div className="flex items-center gap-4 mb-4">
              ...
              <span className="text-white text-xs md:text-sm font-black uppercase tracking-[0.4em]">Vulcan Aviation</span>
            </div>
            <h1 className="text-white text-5xl md:text-8xl font-black uppercase italic leading-[0.9] tracking-tighter">
              SOUTH AFRICA <br /> <span className="text-transparent" style={{ WebkitTextStroke: '1px white' }}>SOUTHERN SKIES</span>
            </h1>
          </motion.div>
        </div>
      </section>
          ...
          <div className="lg:col-span-8">
            <header className="mb-10">
                <h2 className="text-3xl md:text-5xl font-black uppercase italic text-[#1a2e6e] leading-tight">
                    Vulcan Aviation <br/>
                    <span className="text-[#e21d1d]">South Africa</span>
                </h2>
            </header>
            ...
            <div className="space-y-6 text-lg md:text-xl text-gray-600 leading-relaxed">
              <p className="font-bold text-[#1a2e6e] border-l-4 border-[#e21d1d] pl-6 italic">
                Aerius Aviators is pleased to collaborate with Vulcan Aviation in South Africa, a reputed organisation known for delivering robust and industry‑aligned pilot training.
              </p>
              <p>
                Vulcan Aviation offers Indian students an excellent opportunity to complete their CPL in a professional environment supported by experienced instructors and modern methodology. Our partnership ensures comprehensive support—from initial guidance to smooth transition and completion of training, allowing aspiring pilots to train with clarity and confidence.
              </p>
            </div>

            {/* --- MODERN GRID (4 Images) --- */}
            <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              {galleryImages.map((img, index) => (
                ...
                >
                  <img 
                    src={img} 
                    alt="South Africa Flight Training" 
          ...
          <div className="lg:col-span-4">
            <div className="bg-[#1a2e6e] p-10 rounded-[3rem] text-white sticky top-24 shadow-2xl overflow-hidden border border-white/5">
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-black uppercase mb-6 tracking-tight italic">SA Highlights</h3>
                
                <ul className="space-y-5 text-sm font-bold uppercase tracking-widest text-white/60">
                  <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-[#e21d1d]" /> Industry Aligned</li>
                  <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-[#e21d1d]" /> Expert Instructors</li>
                  <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-[#e21d1d]" /> Modern Methodology</li>
                  <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-[#e21d1d]" /> Smooth Transition</li>
                </ul>
