...
import heroImg from '../../assets/australia-flight.png';

// --- ASSET IMPORTS ---
import aus from '../../assets/ausimg/aus.jpg'; 
import aus1 from '../../assets/ausimg/aus2.jpg';
import aus2 from '../../assets/ausimg/aus3.jpg';
import aus3 from '../../assets/ausimg/aus4.jpg';
...
const AustraliaPage = () => {
  ...
  const galleryImages = [aus, aus1, aus2, aus3];
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 w-full relative z-10">
          <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            <div className="flex items-center gap-4 mb-4">
              ...
              <span className="text-white text-xs md:text-sm font-black uppercase tracking-[0.4em]">CASA Pilot Training</span>
            </div>
            <h1 className="text-white text-5xl md:text-8xl font-black uppercase italic leading-[0.9] tracking-tighter">
              AUSTRALIA <br /> <span className="text-transparent" style={{ WebkitTextStroke: '1px white' }}>MELBOURNE BASE</span>
            </h1>
          ...
          <div className="lg:col-span-8">
            ...
            <div className="space-y-6 text-lg md:text-xl text-gray-600 leading-relaxed">
              <p className="font-bold text-[#1a2e6e] border-l-4 border-[#e21d1d] pl-6 italic">
                Train at one of Australia's premier general aviation airports. Moorabbin Airport provides real-world exposure with controlled airspace and busy traffic.
              </p>
              <p>
                Surrounded by scenic coastlines and cityscapes, students experience both challenging and beautiful flights. Enjoy year-round flying thanks to Australia’s moderate climate, while preparing under CASA-aligned training that boosts global readiness.
              </p>
            </div>

            {/* --- MODERN GRID (Lightbox Enabled) --- */}
          ...
          <div className="lg:col-span-4">
            <div className="bg-[#1a2e6e] p-10 rounded-[3rem] text-white sticky top-24 shadow-2xl overflow-hidden border border-white/5">
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-black uppercase mb-6 tracking-tight italic">CASA Benefits</h3>
                
                <ul className="space-y-5 text-sm font-bold uppercase tracking-widest text-white/60">
                  <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-[#e21d1d]" /> Controlled Airspace</li>
                  <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-[#e21d1d]" /> Scenic Routes</li>
                  <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-[#e21d1d]" /> Year-round Flying</li>
